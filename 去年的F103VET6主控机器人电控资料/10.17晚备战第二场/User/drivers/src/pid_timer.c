...
**************************************************************************/
/**************************************************************************
C8T6中只有1 2 3 4四个定时器，VET6则8个全有
型号为STM32F103x8/B型号的只有4个定时器，1 2 3 4 
型号为STM32F103xC/D/E型号的都有8个定时器
**************************************************************************/
/**************************************************************************
函数功能：配置基本定时器的中断优先级
输入变量：无
...
说明    ：更改时需要更改中断源和优先级
**************************************************************************/
static void PID_BasicTim_NVIC_Config(void)
{
...
static void PID_BasicTim_Mode_Config(void)
{
    ...
    TIM_TimeBaseStructure.TIM_Period = 10*1000-1;	                          // 自动重装载寄存器的值，即设置计数器最大值，让计数次数为所设置的值加一
...
{
	PID_BasicTim_NVIC_Config();
	PID_BasicTim_Mode_Config();
}
/*********************************************通用定时器**********************/
/**************************************************************************
                           ZET6/VET6引脚分布
