...
/**************************************************************************
函数功能：重置某一个串口的寄存器配置
输入变量：USARTx: 选择一个串口外设，
                  可以选 USART1, USART2, USART3, UART4 or UART5.
返回值	：无
**************************************************************************/
...
/**************************************************************************
函数功能：使用配置结构体初始化串口配置寄存器
输入变量：USARTx: 选择一个串口外设，
                  可以选 USART1, USART2, USART3, UART4 or UART5.
          USART_InitStruct: 初始化结构体的指针
返回值	：无
**************************************************************************/
...
/**************************************************************************
函数功能：为初始化结构体设置默认值
输入变量：USART_InitStruct: 初始化结构体的指针
返回值	：无
说明    ：初始化结构体一般自己配置，
          如果使用默认的功能可以使用该函数快速配置
**************************************************************************/
...
/**************************************************************************
函数功能：使用时钟配置结构体初始化串口时钟线的寄存器
输入变量：USARTx: 选择一个串口外设，
                  可以选 USART1, USART2, USART3, UART4 or UART5.
          USART_ClockInitStruct: 初始化结构体的指针
返回值	：无
说明    ：该函数用于同步通信，用于设置同步通信时的时钟模式
**************************************************************************/
...
/**************************************************************************
函数功能：为初始化结构体设置默认值
输入变量：USART_ClockInitStruct: 初始化结构体的指针
返回值	：无
说明    ：初始化结构体一般自己配置，
          如果使用默认的功能可以使用该函数快速配置
**************************************************************************/
...
输入变量：USARTx: 选择一个串口外设，
                  可以选 USART1, USART2, USART3, UART4 or UART5.
          NewState:开还是关，DISABLE = 0关, ENABLE = 1开
返回值	：无
说明    ：设置的是寄存器CR1的UE位
          设置为1时用于启动串口
