...
typedef struct
{
  uint16_t TIM_Prescaler;         /*!< Specifies the prescaler value used to divide the TIM clock.分频器，配置分频因子，决定记一次的时间
                                       This parameter can be a number between 0x0000 and 0xFFFF */

  uint16_t TIM_CounterMode;       /*!< Specifies the counter mode.
                                       This parameter can be a value of @ref TIM_Counter_Mode */

  uint16_t TIM_Period;            /*!< Specifies the period value to be loaded into the active 自动重装载寄存器ARR的值，用于配置周期
...
} TIM_BDTRInitTypeDef;//刹车、死区时间配置寄存器
